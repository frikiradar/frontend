...
/* harmony import */ var _rest_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./rest.service */ 69716);
...
class TagService {
  ...
  searchTag(tag, category) {
    ...
    return (0,_home_albertomerino_frikiradar_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      try {
        return yield _this.rest.post("tags", {
          tag,
          category
        });
      } catch (e) {
  ...
  addTag(name, category, slug) {
    var _this2 = this;
    return (0,_home_albertomerino_frikiradar_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return yield _this2.rest.put("add-tag", {
        name,
        category,
        slug
      });
  ...
  removeTag(id) {
    var _this3 = this;
    return (0,_home_albertomerino_frikiradar_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      return yield _this3.rest.delete(`tag/${id}`);
    })();
  }
}
_TagService = TagService;
_TagService.ɵfac = function TagService_Factory(t) {
  return new (t || _TagService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_rest_service__WEBPACK_IMPORTED_MODULE_1__.RestService));
};
_TagService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({
  token: _TagService,
...
/* harmony export */ });
/* harmony import */ var _index_7a952e7a_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-7a952e7a.js */ 90614);
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_home_albertomerino_frikiradar_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
...
const createKeyboardController = /*#__PURE__*/function () {
  var _ref = (0,_home_albertomerino_frikiradar_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (keyboardChangeCallback) {
    ...
    const init = /*#__PURE__*/function () {
      var _ref2 = (0,_home_albertomerino_frikiradar_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
const createLockController = () => {
  ...
  const lock = /*#__PURE__*/function () {
    var _ref = (0,_home_albertomerino_frikiradar_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const p = waitPromise;
      let resolve;
