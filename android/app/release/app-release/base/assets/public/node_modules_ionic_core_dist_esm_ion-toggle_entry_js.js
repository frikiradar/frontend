...
const Toggle = class {
  constructor(hostRef) {
    ...
    this.disabled = false;
    this.value = 'on';
    this.enableOnOffLabels = _ionic_global_81a1064f_js__WEBPACK_IMPORTED_MODULE_7__.c.get('toggleOnOffLabels');
  ...
  renderToggleControl() {
    ...
    }, enableOnOffLabels && mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_7a952e7a_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  render() {
    ...
    }, this.inheritedAttributes)), (0,_index_7a952e7a_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
