"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_revenuecat_purchases-capacitor_dist_esm_web_js"],{
...
/* harmony export */   PurchasesWeb: () => (/* binding */ PurchasesWeb)
/* harmony export */ });
/* harmony import */ var _capacitor_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @capacitor/core */ 14070);
/* harmony import */ var _revenuecat_purchases_typescript_internal_esm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @revenuecat/purchases-typescript-internal-esm */ 85685);
/* eslint-disable @typescript-eslint/no-unused-vars */


class PurchasesWeb extends _capacitor_core__WEBPACK_IMPORTED_MODULE_0__.WebPlugin {
  constructor() {
    super(...arguments);
    ...
    this.mockEmptyCustomerInfo = {
      entitlements: {
        all: {},
        active: {},
        verification: _revenuecat_purchases_typescript_internal_esm__WEBPACK_IMPORTED_MODULE_1__.VERIFICATION_RESULT.NOT_REQUESTED
      },
      activeSubscriptions: [],
  ...
  removeCustomerInfoUpdateListener(_listenerToRemove) {
    return this.mockReturningFunctionIfEnabled('removeCustomerInfoUpdateListener', {
      wasRemoved: false
    });
  }
  ...
  removeShouldPurchasePromoProductListener(_listenerToRemove) {
    return this.mockReturningFunctionIfEnabled('removeShouldPurchasePromoProductListener', {
      wasRemoved: false
    });
  }
  getOfferings() {
  ...
  beginRefundRequestForActiveEntitlement() {
    const mockResult = {
      refundRequestStatus: _revenuecat_purchases_typescript_internal_esm__WEBPACK_IMPORTED_MODULE_1__.REFUND_REQUEST_STATUS.USER_CANCELLED
    };
...
//# sourceMappingURL=node_modules_revenuecat_purchases-capacitor_dist_esm_web_js.js.map